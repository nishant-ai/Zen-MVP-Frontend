      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
            Zen - A Real Time Chat Application with Sentiment Analysis
          </h1>
          <p className="mb-8 text-xl leading-relaxed">
            We use one of the most effective algorithms to analyse the
            sentimental category of an ongoing chat. Using the concepts of Web
            Sockets and Naive Bayes Algorithm with a rich dataset trained model
            provides a great experience!
          </p>
          <p className="mb-8 text-xl leading-relaxed">
            Register yourself and have a greater sense of social connection in
